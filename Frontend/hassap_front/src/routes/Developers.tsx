...
const creatorsData: Creator[] = [
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/oscar-david-vergara-moreno-b0018b146?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
  ...
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/juan-jos%C3%A9-rodr%C3%ADguez-68a595255?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  ...
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/juan-diego-sotelo-aguilar-b421741a3?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
  ...
  },
  {
    ...
    linkedin:
      "https://www.linkedin.com/in/daniel-santiago-ramirez-chinchilla-a235aa25a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
            ...
            <div className="creator-image-container">
              <img
                ...
                className={`creator-image${
                  creator.name === "Oscar Vergara" ? " oscar-image" : ""
                }`}
              />
              <div className="creator-overlay">
                <div className="creator-social">
                  ...
                  {creator.email && (
                    <button
                      onClick={(e) =>
                        handleLinkClick(e, `mailto:${creator.email}`)
                      }
                      className="social-link"
